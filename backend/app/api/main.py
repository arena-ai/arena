...
from app.api.routes import dde, documents, settings, events, login, users, utils
...
api_router.include_router(dde.router, prefix="/dde", tags=["document-data-extractors"])
