...
# Event Identifier
def get_event_identifier(*, session: Session, event_identifier: str) -> EventIdentifier | None:
    statement = select(EventIdentifier).where(EventIdentifier.id == event_identifier)
...
def create_event_identifier(*, session: Session, event_identifier: str, event_id: int) -> EventIdentifier:
    db_event_identifier = EventIdentifier(id=event_identifier, event_id=event_id)
...
def delete_event_identifier(*, session: Session, event_identifier: str) -> None:
    db_event_identifier = get_event_identifier(session=session, event_identifier=event_identifier)
...
def create_attribute_if_not_exist(*, session: Session, attribute: str) -> Attribute:
...
def create_event_attribute_from_name_value(*, session: Session, attribute: str, value: str | None = None, event_id: int) -> EventAttribute:
    db_attribute = create_attribute_if_not_exist(session=session, attribute=attribute)
    db_event_attribute = EventAttributeCreate(event_id=event_id, attribute_id=db_attribute.id, value=value)
    return create_event_attribute(session=session, event_attribute_in=db_event_attribute)


def delete_event_attribute(*, session: Session, attribute: str, event: int) -> None:
