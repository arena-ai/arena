...
from app.lm.handlers import OpenAIHandler, MistralHandler, AnthropicHandler, ArenaHandler
from app.ops import cst, tup
from app.ops.settings import language_models_api_keys, lm_config
from app.ops.events import log_request, log_response, create_event_identifier, log_lm_judge_evaluation, log_lm_config
...
@router.post("/openai/chat/completions", response_model=openai_models.ChatCompletionResponse)
...
@router.post("/mistral/v1/chat/completions", response_model=mistral_models.ChatCompletionResponse)
...
@router.post("/anthropic/v1/messages", response_model=anthropic_models.ChatCompletionResponse)
