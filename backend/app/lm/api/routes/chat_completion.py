...
async def chat_completion_response_event(session: Session, current_user: User, request_event_id: int, chat_completion: ChatCompletionResponse) -> Event:
...
async def chat_completion(
    session: SessionDep, current_user: CurrentUser, chat_completion_in: ChatCompletionRequest
...
async def chat_completion_request(
    session: SessionDep, current_user: CurrentUser, chat_completion_create: ChatCompletionRequest
) -> Event:
...
async def chat_completion_response(
    session: SessionDep, current_user: CurrentUser, request_event_id: int, chat_completion: ChatCompletionResponse
) -> Event:
