...
async def openai_chat_completion(
    ...
    return await OpenAI(api_key=openai_api_key.content).chat_completion(ccc=openai.ChatCompletionCreate.model_validate(chat_completion_in))
...
async def mistral_chat_completion(
    ...
    return await Mistral(api_key=mistral_api_key.content).chat_completion(ccc=mistral.ChatCompletionCreate.model_validate(chat_completion_in))
