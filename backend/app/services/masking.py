...
class AnalyzerRequest(BaseModel):
    ...
    entities: Sequence[str] | None = Field(
        default=None,
        description="""A list of values among the possible entities:
...
class Anonymizers(BaseModel):
    ...
    US_DRIVER_LICENSE: (
        Replace | Redact | Mask | Hash | Encrypt | Keep | None
    ) = None
    ...
    US_BANK_NUMBER: Replace | Redact | Mask | Hash | Encrypt | Keep | None = (
        None
    )
    EMAIL_ADDRESS: Replace | Redact | Mask | Hash | Encrypt | Keep | None = (
        None
    )
    ...
    MEDICAL_LICENSE: Replace | Redact | Mask | Hash | Encrypt | Keep | None = (
        None
    )
...
class AnonymizedItem(BaseModel):
    ...
    entity_type: (
        str  # From https://microsoft.github.io/presidio/supported_entities/
    )
    start: int
    end: int
    text: str | None = None
