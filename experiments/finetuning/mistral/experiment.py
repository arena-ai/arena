...
${HOME}/.local/bin/torchrun --nproc-per-node 4 inference.py --lora-path $(awk '/run_dir:/ {print $2}' ${HOME}/7B_instruct.yaml)/checkpoints/checkpoint_000600/consolidated/lora.safetensors
""")
